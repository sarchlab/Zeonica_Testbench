...
{
  GEP, [arg5], [$0] -> [$2], [WEST, RED] (t=19, inv_iters=1)
  DATA_MOV, [NORTH, RED] -> [$0] (t=19, inv_iters=1)
} (idx_per_ii=4)
{
...
PE(0,1):
{
  GEP, [arg3], [$3] -> [NORTH, RED] (t=15, inv_iters=1)
  DATA_MOV, [EAST, RED] -> [$0] (t=15, inv_iters=1)
} (idx_per_ii=0)
{
...
{
  GEP, [arg4], [$0] -> [NORTH, RED] (t=19, inv_iters=1)
} (idx_per_ii=4)
{
...
{
  GEP, [arg2], [$3] -> [WEST, RED] (t=14, inv_iters=0)
  DATA_MOV, [SOUTH, RED] -> [EAST, RED] (t=14, inv_iters=0)
} (idx_per_ii=14)

PE(2,1):
{
  GEP, [arg3], [$1] -> [EAST, RED] (t=15, inv_iters=1)
} (idx_per_ii=0)
{
  GEP, [arg2], [WEST, RED] -> [SOUTH, RED] (t=16, inv_iters=1)
...
{
  GEP, [arg2], [$0] -> [SOUTH, RED] (t=14, inv_iters=0)
} (idx_per_ii=14)
...
{
  GEP, [arg1], [WEST, RED] -> [SOUTH, RED] (t=17, inv_iters=1)
} (idx_per_ii=2)
{
...
{
  GEP, [arg5], [$0] -> [SOUTH, RED], [$0] (t=19, inv_iters=1)
} (idx_per_ii=4)
{
...
{
  GEP, [arg5], [$0] -> [$3], [$5] (t=20, inv_iters=1)
...
{
  GEP, [arg3], [SOUTH, RED] -> [WEST, RED] (t=16, inv_iters=1)
} (idx_per_ii=1)
{
...
{
  GEP, [arg5], [$0] -> [WEST, RED], [NORTH, RED] (t=19, inv_iters=1)
} (idx_per_ii=4)
{
...
{
  GEP, [arg4], [SOUTH, RED] -> [SOUTH, RED] (t=18, inv_iters=1)
...
{
  GEP, [arg4], [$0] -> [$2] (t=18, inv_iters=1)
  DATA_MOV, [EAST, RED] -> [$0] (t=18, inv_iters=1)
} (idx_per_ii=3)
{
  GEP, [arg5], [$1] -> [SOUTH, RED], [$3] (t=19, inv_iters=1)
...
{
  GEP, [arg1], [SOUTH, RED] -> [WEST, RED] (t=18, inv_iters=1)
} (idx_per_ii=3)
{
