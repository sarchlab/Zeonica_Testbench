...
PE(1,1):
{
  ICMP_SGT, [NORTH, RED], [#0] -> [EAST, RED]
} (t=1)
{
  GRANT_PREDICATE, [NORTH, RED], [EAST, RED] -> [WEST, RED], [$0]
} (t=3)
{
  ICMP_ULT, [$0], [#4] -> [WEST, RED], [NORTH, RED], [$6], [EAST, RED]
  DATA_MOV, [EAST, RED] -> [SOUTH, RED]
} (t=4)
{
  DATA_MOV, [NORTH, RED] -> [$5]
} (t=5)
{
...
{
  ICMP_EQ, [$1], [$0] -> [$2], [EAST, RED], [$1], [WEST, RED]
  DATA_MOV, [EAST, RED] -> [SOUTH, RED]
  DATA_MOV, [SOUTH, RED] -> [$0]
} (t=11)
{
