...
{
  GEP, [arg0], [NORTH, RED] -> [WEST, RED], [$0] (t=12, inv_iters=0)
} (idx_per_ii=12)
{
...
{
  ICMP_EQ, [EAST, RED], [SOUTH, RED] -> [$0], [EAST, RED], [$1], [$5], [$4], [$3], [NORTH, RED], [SOUTH, RED] (t=11, inv_iters=0)
} (idx_per_ii=11)
{
  NOT, [$0] -> [$1], [$14], [$13], [$12], [$11], [SOUTH, RED], [$10], [$9], [$8], [$7], [$6], [$5] (t=12, inv_iters=0)
  DATA_MOV, [EAST, RED] -> [$0] (t=12, inv_iters=0)
  DATA_MOV, [$1] -> [EAST, RED] (t=12, inv_iters=0)
  DATA_MOV, [$5] -> [$3] (t=12, inv_iters=0)
  DATA_MOV, [$3] -> [NORTH, RED] (t=12, inv_iters=0)
} (idx_per_ii=12)
{
  GRANT_PREDICATE, [$0], [$1] -> [EAST, RED] (t=13, inv_iters=0)
  DATA_MOV, [$14] -> [$12] (t=13, inv_iters=0)
  DATA_MOV, [$13] -> [$10] (t=13, inv_iters=0)
  DATA_MOV, [$12] -> [$9] (t=13, inv_iters=0)
  DATA_MOV, [EAST, RED] -> [$8] (t=13, inv_iters=0)
  DATA_MOV, [$10] -> [$6] (t=13, inv_iters=0)
  DATA_MOV, [$9] -> [$5] (t=13, inv_iters=0)
  DATA_MOV, [$8] -> [$3] (t=13, inv_iters=0)
  DATA_MOV, [$6] -> [$1] (t=13, inv_iters=0)
  DATA_MOV, [$5] -> [NORTH, RED] (t=13, inv_iters=0)
  DATA_MOV, [$3] -> [SOUTH, RED] (t=13, inv_iters=0)
  DATA_MOV, [SOUTH, RED] -> [$0] (t=13, inv_iters=0)
} (idx_per_ii=13)
{
  DATA_MOV, [$12] -> [$6] (t=14, inv_iters=0)
  DATA_MOV, [$10] -> [$5] (t=14, inv_iters=0)
  DATA_MOV, [$9] -> [$3] (t=14, inv_iters=0)
  DATA_MOV, [$6] -> [NORTH, RED] (t=14, inv_iters=0)
  DATA_MOV, [$5] -> [$1] (t=14, inv_iters=0)
...
} (idx_per_ii=14)
{
  ...
  DATA_MOV, [$5] -> [$2] (t=15, inv_iters=0)
  DATA_MOV, [$3] -> [$1] (t=15, inv_iters=0)
...
{
  NOT, [$0] -> [NORTH, RED], [$7], [$6], [$5], [$4], [WEST, RED], [SOUTH, RED] (t=16, inv_iters=0)
...
} (idx_per_ii=16)
{
  ...
  DATA_MOV, [$7] -> [$1] (t=17, inv_iters=0)
  DATA_MOV, [$6] -> [WEST, RED] (t=17, inv_iters=0)
  DATA_MOV, [$5] -> [$0] (t=17, inv_iters=0)
...
{
  GEP, [arg1], [$0] -> [WEST, RED], [EAST, RED] (t=14, inv_iters=0)
