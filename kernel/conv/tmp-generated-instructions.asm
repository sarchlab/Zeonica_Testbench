...
PE(2,0):
{
  GRANT_PREDICATE, [NORTH, RED], [$0] -> [$0] (t=11, inv_iters=2)
} (idx_per_ii=1)
{
...
{
  LOAD, [NORTH, RED] -> [$8] (t=7, inv_iters=1)
} (idx_per_ii=2)
{
  MUL, [$0], [$8] -> [WEST, RED] (t=8, inv_iters=1)
} (idx_per_ii=3)
...
PE(2,1):
{
  ADD, [SOUTH, RED], [$0] -> [WEST, RED], [SOUTH, RED] (t=10, inv_iters=2)
} (idx_per_ii=0)
{
...
{
  GEP, [arg6], [$0], [$8] -> [SOUTH, RED] (t=6, inv_iters=1)
} (idx_per_ii=1)
{
...
{
  ICMP_EQ, [$0], [#4200] -> [$0], [WEST, RED] (t=3, inv_iters=0)
...
{
  ZEXT, [$0] -> [SOUTH, RED] (t=4, inv_iters=0)
} (idx_per_ii=4)
