...
{
  DATA_MOV, [NORTH, RED] -> [SOUTH, RED] (t=8, inv_iters=1)
} (idx_per_ii=3)
...
{
  ICMP_EQ, [$0], [#16] -> [$0], [WEST, RED] (t=3, inv_iters=0)
} (idx_per_ii=3)
{
...
{
  DATA_MOV, [$0] -> [SOUTH, RED] (t=6, inv_iters=1)
} (idx_per_ii=1)
...
{
  GEP, [arg1], [$0] -> [WEST, RED] (t=3, inv_iters=0)
} (idx_per_ii=3)
